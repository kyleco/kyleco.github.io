...
#### Selection bias
 ...
 _Selection bias_ is a systematic difference in $$Y^0$$ between the treatment and control groups. Selection bias occurs when the two groups are systematically different even in the absence of an actual treatment. In the UNICEF ads example this would happen if the ad is more likely to be shown to users that searched for "UNICEF". Even in a world where there are no UNICEF ads, the people who searched for UNICEF are much more likely to donate than those who did not.
